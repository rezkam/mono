...
func main() {
	...
	apiKey, err := auth.CreateAPIKey(ctx, store, cfg.APIKeyType, cfg.APIServiceName, cfg.APIVersion, cfg.Name, expiresAt)
	if err != nil {
	...
	fmt.Println("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	fmt.Printf("Name: %s\n", cfg.Name)
	fmt.Printf("Format: %s-%s-%s-{short}-{long}\n", cfg.APIKeyType, cfg.APIServiceName, cfg.APIVersion)
	if expiresAt != nil {
